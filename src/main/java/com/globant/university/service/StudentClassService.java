...
public interface StudentClassService {
    ...
    List<StudentClassResponseDTO> findByClassId(Integer classId) throws Exception;


    List<StudentClassResponseDTO> findByStudentId(Integer studentId) throws Exception;
}